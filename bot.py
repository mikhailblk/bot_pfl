...
# ========== ДАННЫЕ РАСТЕНИЙ ==========
PLANTS = [
    Plant("gs1", "🧄 Garlic Skittlez", 10, 30.0, 1.0, "Hybrid", "Eufloria 30/1 GSZ - Ein intensives Aroma mit knoblauchartigen Noten.", 1),
    Plant("mc1", "🍪 Minty Cookies", 10, 27.0, 1.0, "Hybrid", "enua 27/1 PS3 CA MYC - Frische Minze mit süßen Cookie-Noten.", 2),
    Plant("cd1", "🍩 Crispy Doughnut", 10, 25.0, 1.0, "Indica dominant", "enua 25/1 CDG CA - Wie ein frischer Doughnut.", 3),
    Plant("sm1", "🖍️ Scented Marker", 12, 33.0, 1.0, "Indica dominant", "420 Evolution 33/1 CA SCM - Intensives Aroma.", 4),
    Plant("pk1", "🌸 Pink Kush", 10, 24.5, 1.0, "Hybrid", "enua 27/1 PS3 PNK - Sanft und entspannend.", 5),
    Plant("mn1", "🍬 Munyunz", 10, 27.0, 1.0, "Sativa dominant", "Remexian 27/1 GJY MUN - Energiegeladen.", 6),
    Plant("pc1", "🟣 Purple Churro", 12, 27.0, 1.0, "Indica dominant", "Eufloria 27/1 PCH - Süß und würzig.", 7),
    Plant("zr1", "🍬 Zlush Runtz", 12, 30.0, 1.0, "Indica dominant", "Eufloria 30/1 ZRU - Fruchtig und stark.", 8),
    Plant("ok1", "🌲 OG Kush", 10, 22.0, 1.0, "Hybrid", "Slouu 22/1 PS3 CA OGK - Klassiker mit Kiefernaroma.", 9),
    Plant("ww1", "🕷️ White Widow", 10, 18.0, 1.0, "Hybrid", "Weeco 1A 18/1 WW - Legendärer Strain.", 10),
    Plant("mo1", "🍡 Marshmallow OG", 12, 27.0, 1.0, "Indica dominant", "Eufloria 27/1 MOG - Sanft und süß.", 11),
    Plant("pf1", "🍍 Pineapple Fruz", 12, 27.0, 1.0, "Sativa dominant", "420 Evolution 27/1 CA PEX - Tropischer Geschmack.", 12),
    Plant("ss1", "🍬 Sweet San Valley", 12, 30.0, 1.0, "Indica dominant", "enua SSV CA 30/1 - Sanft und entspannend.", 13),
    Plant("pg1", "🍍 Pineapple God", 12, 25.0, 1.0, "Sativa dominant", "Huala 25/1 CA POG - Exotisch und fruchtig.", 14),
    Plant("jf1", "🌴 Jungle Fumes", 15, 36.0, 1.0, "Sativa dominant", "enua 36/1 JGF CA - Extrem potent.", 15),
    Plant("co1", "🍪 Cookies OG", 12, 30.0, 0.9, "Hybrid", "TRUU GT 30:01 - Süß und erdig.", 16),
    Plant("aa1", "🧠 Amsterdam Amnesia", 17, 24.0, 0.9, "Sativa", "Cannamedical Sativa Forte NM - Klassischer Geschmack.", 17),
    Plant("sl1", "🍋 Super Lemon G", 12, 5.6, 6.8, "Sativa", "420 Balanced Basic PT SLG - Ausgewogen und zitronig.", 18),
    Plant("pr1", "🌧️ Purple Rain", 10, 21.2, 0.9, "Sativa", "Weeco Duke 20/1 - Fruchtig und entspannend.", 19),
    Plant("fc1", "💎 First Class Funk", 15, 28.0, 0.9, "Indica dominant", "Demecan CRAFT FCF 28:01 - Premium Qualität.", 20),
    Plant("ls1", "🍋 Lemon Slushie", 15, 20.0, 1.0, "Sativa", "Cannamedical Sativa Classic - Erfrischend und belebend.", 21),
    Plant("wt1", "💍 Wedding Tree", 17, 24.0, 0.9, "Sativa", "Cannamedical Sativa forte NM - Elegant und stark.", 22),
    Plant("pc2", "🍑 Peach Chementine", 15, 30.0, 0.9, "Hybrid", "420 Evolution 30/1 CA PCH - Fruchtig und potent.", 23),
]
